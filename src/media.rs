...
/// referencing the on-disk path. Fallback for files that are neither audio
/// (STT), inlineable text, nor images.
///
/// Files land at `${OPENAB_ATTACHMENTS_DIR:-/tmp/openab-attachments}/<bucket>/<filename>`.
